...
int main()
{
	...
	try
	{
		...
		std::string IterationBestFileName = "../../DataSet/TestData/IB.txt";
		std::vector<std::vector<int>> Solution;
		BIOCommon::parseSolutionFile(IterationBestFileName, Solution);

		BIOUtility::parseBioUtilityConfig("ConfigUtility.xml");
		if (BIOUtility::optimizeSolutionByLocalSearch(StrSet, Solution))
